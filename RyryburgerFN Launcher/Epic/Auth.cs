...
namespace RyryburgerFN_Launcher.Epic
{
    internal class Auth
    {
        public static string GetDevicecodetoken()
        {
            ...
            restRequest1.AddHeader("Authorization", "Basic NTIyOWRjZDNhYzM4NDUyMDhiNDk2NjQ5MDkyZjI1MWI6ZTNiZDJkM2UtYmY4Yy00ODU3LTllN2QtZjNkOTQ3ZDIyMGM3");
